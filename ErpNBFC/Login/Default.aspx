<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ErpNBFC.Default" %>
                        ...
                        <div class="tab-pane active" id="panel1">
                            <div class="row-fluid">
                                <div class="span5">
                                    ...
                                    <br />
                                    <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Sign In" OnClick="Button1_Click" />
                                </div>
                                <div class="span3">
                        ...
                        <div id="panel4" class="tab-pane">
                            <div class="row-fluid">
                                <div class="span5">
                                    ...
                                    <asp:TextBox ID="messagetest" TextMode="MultiLine" class="input-block-level"  runat="server"></asp:TextBox>
                                    <asp:Button ID="Button3" CssClass="btn" runat="server" Text="Send Message" OnClick="Button3_OnClick" />
