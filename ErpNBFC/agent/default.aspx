<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ErpNBFC.agent._default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Login Agent | Holiday Zone India</title>
    <link href='http://fonts.googleapis.com/css?family=PT+Sans:400,700' rel='stylesheet' type='text/css'/>
    <link href="../Login/css/bootstrap.css" rel="stylesheet" />
    <link href="../Login/css/responsive-min.css" rel="stylesheet" />
    <link href="../Login/css/preview.css" rel="stylesheet" />
    <link href="../Login/css/fontawesome.css" rel="stylesheet" />
</head>
<body>
                        ...
                        <div class="tab-pane active" id="panel1">
                            <div class="row-fluid">
                                <div class="span5">
                                    ...
                                    <asp:TextBox ID="txtUserName" runat="server" class="input-block-level" ></asp:TextBox>
                                    <label>Password<a href="#panel3" class="pull-right"><i class="icon-question-sign"></i>&nbsp;Forgot Password</a> </label>
                                    ...
                                    <br />
                                    <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Sign In" OnClick="Button1_OnClick" />
                                </div>
                                <div class="span3">
                        ...
                        <div class="tab-pane" id="panel3">
                            <div class="row-fluid">
                                <div class="span5">
                                    ...
                                    <label>Email</label>
                                    <asp:TextBox ID="txtEmail" runat="server" class="input-block-level"></asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:Button ID="Button2" class=" btn " runat="server" Text="Recover Password" OnClick="Button4_Click" />
                        ...
                        <div id="panel4" class="tab-pane">
                            <div class="row-fluid">
                                <div class="span5">
                                    ...
                                    <label>Name</label>
                                    <asp:TextBox ID="txtName" runat="server" class="input-block-level" ></asp:TextBox>
                                    <label>Email</label>
                                    <asp:TextBox ID="extEmail" TextMode="Email" runat="server" class="input-block-level" ></asp:TextBox>
                                    <label>Mobile No</label>
                                    <asp:TextBox ID="txtMobile" TextMode="Number" runat="server" class="input-block-level" ></asp:TextBox>
                                    <label>Message</label>
                                    <textarea runat="server" id="txtMessage" class="input-block-level" rows="5"></textarea>
                                    <asp:Button ID="Button3" CssClass="btn" runat="server" Text="Send Message" />
                            ...
                            <div class="tab-pane" id="panel6-3">
                                <div class="row-fluid">
                                    <div class="span5">
                                        ...
                                        <label>Email</label>
                                        <asp:TextBox ID="TxtResetEmail" runat="server"></asp:TextBox>
                                        ...
                                        <asp:Button class="btn" ID="Button4" runat="server" Text="Recover Password" OnClick="Button4_Click" />
                                    </div>
                                    <div class="span7">
                                        <h4><i class="icon-question"></i>&nbsp;&nbsp;Help</h4>
                                        <div class="box">
    ...
    <script src="../Login/js/jquert-1.js"></script>
    <script src="../Login/js/bootstrap.js"></script>
    <script src="../Login/js/tabs.js"></script>
