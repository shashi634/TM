<%@ Page Title="" Language="C#" MasterPageFile="~/p/admin.Master" AutoEventWireup="true" CodeBehind="country.aspx.cs" Inherits="ErpNBFC.p.Country" %>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-flat" Text="Add Location" OnClick="Button1_Click" />
                                <asp:Button ID="Button2" runat="server" CssClass="btn btn-flat" Text="Update Location" OnClick="Button2_Click" />
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <asp:GridView ID="LocationTable" AutoGenerateColumns="false" runat="server"
                                 ...
                                 class="table table-condensed" RowStyle-BorderColor="White"  PageSize="10"
                                 ...
                                 <Columns>
                                     <asp:TemplateField HeaderStyle-BorderColor="White">
                                         <HeaderTemplate > Package Creator</HeaderTemplate>
                                         <ItemTemplate>
                                              <a href='<%#"hotelpackages.aspx?C="+DataBinder.Eval(Container.DataItem,"publicid") %>'>Create Package</a>
                                         </ItemTemplate>
                                     </asp:TemplateField>
                                 </Columns>
                                 <Columns>
                                     <asp:TemplateField HeaderStyle-BorderColor="White">
                                         ...
                                         <ItemTemplate>
                                             <a href='<%#"country.aspx?C="+DataBinder.Eval(Container.DataItem,"publicid") %>'><span class="glyphicon glyphicon-edit"></span></a>
