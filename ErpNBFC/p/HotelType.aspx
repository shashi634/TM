<%@ Page Title="" Language="C#" MasterPageFile="~/p/admin.Master" AutoEventWireup="true" CodeBehind="HotelType.aspx.cs" Inherits="ErpNBFC.p.HotelType" %>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Hotels Type</h3>
                    ...
                    <div class="box-body">
                            <div class="form-group">
                                <div class="col-xs-8">
                                     <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Hotels Type"></asp:TextBox>
                                </div>
                                
                                <div class="col-xs-4">
                                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-flat" Text="List Hotel Type" OnClick="Button1_Click" />
                                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-flat" Text="Update Hotel Type" OnClick="Button2_Click" />
                                </div>
                            </div>
            ...
            <div class="col-sm-6">
                <div class="box box-danger">
                    <div class="box-header with-border">
                        <h3 class="box-title">Listed Hotels Type</h3>
                             ...
                             <asp:GridView ID="hotelsTypes" AutoGenerateColumns="false" runat="server"
                                 ...
                                 <Columns>
                                     <asp:TemplateField HeaderStyle-BorderColor="White">
                                         ...
                                         <ItemTemplate>
                                         <a href='<%#"HotelType.aspx?C="+DataBinder.Eval(Container.DataItem,"publicid") %>'><span class="glyphicon glyphicon-edit"></span></a>
